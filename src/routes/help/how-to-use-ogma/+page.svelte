...
<main class="wiki-content" id="main-content">
    ...
    <div id="gm-table" class="callout">
      ...
      <ol>
        ...
        <li><strong>Track fate points</strong> — open the Session tab in the sidebar for the FP tracker (GM pool = 1 per PC), Popcorn Initiative tracker, and Milestone/Breakthrough checklists.</li>
        <li><strong>Generate on the fly</strong> — need a complication? A countdown? A quick NPC? Roll mid-session. The generators are designed for at-the-table speed.</li>
        <li><strong>Check "How to use this"</strong> — every result has an expandable reference section below it with the mechanic, running tips, and invoke/compel examples.</li>
      </ol>
    </div>
    ...
    <div id="player" class="callout">
      ...
      <ol>
        ...
        <li><strong>Try Session Zero</strong> — the <a href="/campaigns/sessionzero">Session Zero Wizard</a> walks through collaborative character creation step by step. Your GM may use it to guide the group.</li>
      </ol>
    </div>
