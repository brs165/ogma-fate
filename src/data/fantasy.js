...
export const CAMPAIGNS = { fantasy: {
    meta: {
    ...
    tables: {
      ...
      pc_high_concepts: ["Wound-Scholar Who Reads Scars Like Text","Magic-Scarred Survivor of the War That Ended Wrong","Blood-Debt Collector Whose Ledger Goes Back Three Generations","Rune-Burned Seeker Following a Map Only She Can See","Last Practitioner of a School That Shouldn't Have Survived","Kingdom-Fallen Noble Whose Title Means Nothing Outside This Ruin","Battle-Surgeon Who Learned Medicine From What Didn't Kill Her","Curse-Carrier Whose Affliction Has Unexpected Uses","Memory-Trader Who Knows Other People's Pasts Better Than Her Own","Threshold Guardian Whose Post No Longer Exists","Void-Touched Soldier Who Returned When No One Expected","Compact-Broken Mage Carrying the Consequences"],
      pc_questions: ["What cost did your magic extract from you, and does the party know?","Which faction from the old war do you owe allegiance to, and are they still owed it?","What scar do you carry that tells a story you haven't told the group?","Who trained you, and what did you have to promise them?","What do you believe about how the world broke, and is that belief justified?","What do you want from this that you haven't said aloud?"],
      minor_concepts: {
          t: [
            "A {FmAdj} {FmRole}",
      ...
      troubles: ["Every Kingdom I Serve Eventually Falls","The Magic Is Burning Out of Me","I Made a Bargain I Cannot Undo","There Are People Alive Because I Lied to Them","The Crown Wants Me Dead and the Crown is Right","My Power Comes at a Cost That Isn't Mine to Pay","I Cannot Kill the Person I Need To","The Prophecy Names Me and I Refuse It","Honour Has Cost Me Everyone","The God I Serve Has Other Plans","The Compact I Signed Before I Understood What It Was Will Be Honoured","Made a Pact With Something That Always Collects","The Curse Was Supposed to Protect Others","My Ambition Has Burned Every Bridge I Ever Crossed to Get Here","Chosen by the Wrong God for an Unknown Purpose","The Enemy I Couldn't Kill Is Still Patient","The Magic Chose Me at Birth - No Opinion Requested","The Debt I Owe Is to Someone I Have Never Met and They Are About to Collect","The Cursed Blade Whispers and I Have Started Listening","The Court That Exiled Me Still Sends Assassins - They Call It Mercy","The God I Serve and I Disagree on Methodology","My Bloodline Opens Doors I Would Rather Keep Closed","There Are People Alive Because of Terrible Things I Did","The Old Kingdom's Laws Still Apply to Me","I Am the Thing the Old Stories Warned About","The Kingdom I Helped Save Has No Interest in What It Cost Me","Every Ally I Gain Becomes a Target of My Enemies","The Magic Leaves Something Behind Each Time I Use It","My True Name Is Known to the Wrong Entity","I Won the War and Lost Everything I Fought It For","The Crown Has a Legal Claim on My Service I Cannot Contest","I Have Seen the End - It Includes Me","The Magic Left Something Inside Me When It Passed Through","The Old Blood in My Veins Is Wanted by Three Factions and None of Them Care I Am Still Using It","The God I Stopped Believing In Has Not Stopped Believing in Me","The Old Compact Binds My Bloodline - No Choice","I Know What's in the Sealed Vault","The Curse Passes to My Killer - So I Can't Die","The Dead Army I Led Is Still Following","I Was the Last to Hold the Ritual - Did It Wrong","My Power Grows With Despair - Hope Is Depleting","Prophecy Written by Someone Who Hated Me - Still True","I Serve a Dead King Whose Commands Were Never Rescinded","The Magic Recognised What I Spend My Life Denying","The Person Who Made Me What I Am Is Coming to Collect","Everything I've Built Will Be Used Against Them","Three Courts All Claim My Loyalty - None Know the Others","The Scar Where the Spell Exited Has Been Growing for Four Years","I Know How This Age Ends - I Was There Before","Broke an Oath to the Old Gods - Their Silence Is Worse","The Creature I Spared Survived - Now a Problem","Remember the Kingdom Before - Everything Since Disappoints"],
      other_aspects: {
          t: [
      ...
      stunts: [
        {name:"Last Line",skill:"Fight",desc:"+2 to Fight when you are defending a zone that enemies have already entered and you have nowhere left to retreat.",type:"bonus",tags:["combat", "leadership"]},
      ...
      {name:"Arcane Shield",skill:"Lore",desc:"Use Lore to defend against magical attacks.",type:"special",tags:["supernatural", "combat", "survival"]}, {name:"Deadly Aim",skill:"Shoot",desc:"+2 to Shoot when attacking from a hidden position.",type:"bonus",tags:["combat"]}, {name:"Faithful Endurance",skill:"Will",desc:"Once per session, when you would be taken out by a mental or spiritual attack, instead take a severe consequence and stay in the fight.",type:"special",tags:["supernatural","survival","leadership"]}, {name:"Inspiring Leader",skill:"Rapport",desc:"+2 to Create Advantage when boosting ally morale.",type:"bonus",tags:["leadership", "social", "combat"]}, {name:"Shadow Entrance",skill:"Burglary",desc:"+2 to Burglary when entering a location undetected while someone who should be watching is present.",type:"bonus",tags:["subterfuge","stealth","investigation"]}, {name:"Old Debts, New Leverage",skill:"Resources",desc:"+2 to Resources when calling in a favour or invoking a prior transaction rather than spending coin.",type:"bonus",tags:["negotiation","social","knowledge"]}, {name:"Shadow Step",skill:"Stealth",desc:"+2 to Stealth when moving through dim light or shadows.",type:"bonus",tags:["stealth", "movement"]}, {name:"Shield Bash",skill:"Fight",desc:"Use Fight to push an opponent into an adjacent zone.",type:"special",tags:["combat", "movement"]}, {name:"Hardened to the Road",skill:"Physique",desc:"+2 to overcome or defend against the physical effects of sustained forced march, starvation, or environmental hardship.",type:"bonus",tags:["survival","endurance","exploration"]}, {name:"Storm of Blades",skill:"Fight",desc:"Once per scene, use Fight to create a zone aspect 'Swept by Steel' with two free invokes instead of one. Enemies entering or remaining in the zone may be compelled against it.",type:"special",tags:["combat","movement"]},
        ...
        {name:"Words of the First Age",skill:"Lore",desc:"+2 to create advantages when negotiating with magical creatures, ancient entities, or those bound by old compacts.",type:"bonus",tags:["knowledge", "supernatural", "social"]}],
      scene_tone: {
          t: [
            "{FtAdj} and {FtAdj2}",
            "{FtNoun}-heavy {FtQual}",
      ...
      current_issues: [
        {name:"The Inquisition's Reach Extends",desc:"The old king is dead and three heirs each hold a third of the army. War hasn't been declared. Everyone knows it's already started.",faces:[{name:"Duke Aldric Stoneheart",role:"Most likely to strike first - and knows it"}],places:["The Royal Capital","The Three Border Fortresses"]},
        {name:"The Road Tax Becomes Extortion",desc:"The Duke's toll collectors have begun seizing goods outright. Merchants are refusing to travel. Two trade towns are already choosing sides.",faces:[{name:"Toll-Master Serath Dorn",role:"Enforcing the Duke's orders with increasing enthusiasm"},{name:"Merchant Factor Ulwen",role:"Organising the trader guilds' quiet resistance"}],places:["The Coin Bridge","The Merchant Quarter of Ashton Ford"]},
