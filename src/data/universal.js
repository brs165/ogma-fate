...
// Every entry works in ALL 7 campaigns. Deduplicated vs all campaign tables.
...
export const UNIVERSAL = {
  ...
  stunts: [
    {name:"Combat Medic", skill:"Academics", desc:"+2 to overcome when treating physical consequences under time pressure.", type:"bonus", tags:["knowledge","combat","survival"]},
    {name:"Danger Sense", skill:"Notice", desc:"+2 to defend against ambushes or surprise attacks.", type:"bonus", tags:["combat","investigation","survival"]},
    {name:"Hard to Kill", skill:"Physique", desc:"+2 to defend against physical attacks when you already have a consequence.", type:"bonus", tags:["combat","survival"]},
    {name:"Lie Detector", skill:"Empathy", desc:"+2 to overcome or create advantage when detecting lies.", type:"bonus", tags:["investigation","social","subterfuge"]},
    {name:"First Strike", skill:"Shoot", desc:"+2 to attack on the first exchange of a conflict before anyone has acted.", type:"bonus", tags:["combat"]},
    {name:"Disarming Charm", skill:"Rapport", desc:"+2 to overcome social obstacles when you have had no prior hostile interaction with the target.", type:"bonus", tags:["social","negotiation"]},
    {name:"Menacing Stare", skill:"Provoke", desc:"+2 to create advantage by threatening someone who is outnumbered or outmatched.", type:"bonus", tags:["intimidation","social"]},
    {name:"Lockbreaker", skill:"Burglary", desc:"+2 to overcome when bypassing physical locks, seals, or security mechanisms.", type:"bonus", tags:["subterfuge","technical"]},
    {name:"Field Mechanic", skill:"Crafts", desc:"+2 to overcome when repairing equipment under fire or time pressure.", type:"bonus", tags:["technical","repair","combat"]},
    {name:"Tracker", skill:"Investigate", desc:"+2 to overcome when following a trail or tracking someone through difficult terrain.", type:"bonus", tags:["investigation","survival","movement"]},
    {name:"Sure-Footed", skill:"Athletics", desc:"+2 to overcome movement impediments in any difficult terrain.", type:"bonus", tags:["movement","survival"]},
    {name:"Well Connected", skill:"Contacts", desc:"+2 to overcome when looking for a specific person or service in a populated area.", type:"bonus", tags:["social","investigation"]},
    {name:"Evasive Manoeuvres", skill:"Drive", desc:"+2 to defend when operating a vehicle, mount, or conveyance under pursuit.", type:"bonus", tags:["movement","combat"]},
    {name:"Unshakeable", skill:"Will", desc:"+2 to defend against Provoke when you have chosen to stand your ground.", type:"bonus", tags:["intimidation","social","combat"]},
    {name:"Deep Pockets", skill:"Resources", desc:"+2 to overcome when acquiring uncommon but obtainable goods or services.", type:"bonus", tags:["social","negotiation"]},
    {name:"Ambush Striker", skill:"Stealth", desc:"+2 to attack when your target is not yet aware of your presence.", type:"bonus", tags:["stealth","combat","subterfuge"]},
    {name:"Encyclopedic Knowledge", skill:"Lore", desc:"+2 to create advantage when recalling obscure facts relevant to the current situation.", type:"bonus", tags:["knowledge","investigation"]},
    {name:"Deceptive Feint", skill:"Deceive", desc:"+2 to create advantage in combat by faking an opening.", type:"bonus", tags:["subterfuge","combat"]},
    {name:"Weapon Specialist", skill:"Fight", desc:"When attacking with Fight and invoking an aspect representing careful positioning, gain Weapon:2.", type:"special", tags:["combat"]},
    {name:"Armoured Up", skill:"Physique", desc:"You have Armor:2 against physical attacks as long as you are wearing appropriate protection.", type:"special", tags:["combat","survival"]},
    {name:"Apex Flexibility", skill:"varies", desc:"Twice per session, use your apex skill in place of any other skill.", type:"special", tags:["knowledge","social","combat"]},
    {name:"Zone Assault", skill:"Fight", desc:"Once per scene, attack all enemies in your zone with Fight.", type:"special", tags:["combat","leadership"]},
    {name:"Ranged Zone Assault", skill:"Shoot", desc:"Once per scene, attack all enemies in an adjacent zone with Shoot.", type:"special", tags:["combat"]},
    {name:"Indomitable", skill:"Will", desc:"Once per scene, when you would take a mental consequence, you may instead clear your mental stress track entirely.", type:"special", tags:["intimidation","survival"]},
    {name:"Second Wind", skill:"Physique", desc:"Once per scene, clear your physical stress track as a free action.", type:"special", tags:["combat","survival"]},
    {name:"Stroke of Luck", skill:"varies", desc:"Once per session, reroll any roll and take the better result.", type:"special", tags:["survival"]},
    {name:"Sense Motive", skill:"Empathy", desc:"Once per scene, you may ask the GM one true thing about any NPC's emotional state or hidden motivation.", type:"special", tags:["investigation","social"]},
    {name:"Never Unarmed", skill:"Fight", desc:"You always have a small concealed weapon on your person, even when searched. This is a narrative fact, not a roll.", type:"special", tags:["combat","subterfuge"]}
  ],
  consequence_mild: ["Breathing Wrong After That Hit","Still Blinking Away the Impact","Left Hand Won't Stop Shaking","That's Going to Leave a Scar","Moving Slower Than I Should Be","Last Hit Cost More Than It Showed","Something Pulled in the Scramble","Head's Not Quite Right","Got What I Needed — Paid for It","Can't Hear Properly on the Left","Pride Takes a Hit Too","The Ground Came Up Fast","Ribs Complain Every Breath","Stiff Where I Was Hit","Not as Fast as I Was an Hour Ago","Trust Cracked — Not Broken Yet","Tunnel Vision Coming and Going","Less Blood Than It Looks — Still Too Much","Shoulder Not Tracking Right","Won't Show It, But I'm Feeling It"],
