...
export const CAMPAIGNS = { postapoc: {
    meta: {
    ...
    tables: {
      ...
      pc_high_concepts: ["Road-Hardened Courier Who Knows Every Settlement's Debt","Vault-Born Archivist on First Surface Assignment","Former Warlord Soldier Who Chose the Wrong Side to Defect From","Settlement Medic Running Out of Both Supplies and Optimism","Pre-War Tech Specialist With a Working Device and No Instructions","Water Rights Enforcer Who Started Questioning the Rules","Long-Haul Trucker With More Debts Than Cargo","Community Protector Whose Community Is Gone","Reclamation Cult Apostate Still Carrying the Relics","Scavenger Who Found Something That Should Not Exist","Zone Scout With a Map No One Has Officially Seen","Neutral Broker Whose Neutrality Just Ran Out"],
      pc_questions: ["What do you carry from Before that has no practical value, and why haven't you traded it?","Which settlement do you owe something to, and have you paid it back?","What did you have to do to get through the first year, and who knows about it?","Who in the group reminds you of someone you lost, and have you told them?","What do you believe the new world should become, and have you ever tried to build it?","What route do you know that no one else on this crew does?"],
      minor_concepts: {
          t: [
            "A {PmAdj} {PmRole}",
      ...
      minor_weaknesses: ["Needs the Medicine More Than the Money","Family Is Somewhere in the Wastes - That's Leverage","The Radiation Has Already Won","Will Turn on Anyone Who Threatens Their Stash","One Reminder of Before and They Break","Owes a Debt to the Warlord That Won't Clear","The Hunger Has Made Them Unpredictable","Terrified of the Dark Since the Incident","Can't Read - That's More Dangerous Than It Sounds","Loyalty to a Dead Faction They Haven't Let Go Of","Radiation Count Already Too High - This Trip Worsens It","Their Settlement Would Not Survive Losing Them","Three People Know Their Real Name From Before - One Is Here","The Medicine Keeps Them Functional and Running Low","Can't Leave a Kid Behind. Full Stop.","Pride About the Old Skills - Will Not Admit They've Rusted","Old Faction Brand Still Visible - Wrong Territory","The Injury Didn't Heal Right and Never Will","Compelled to Hoard - Even Things They Don't Need","Owes Two Seasons of Tithe to the Wrong Warlord","Terrified of the Sick - Irrational, Uncontrollable","Can't Shoot Someone They Know - It's a Problem","The Thing They Carry Draws the Wrong Kind of Attention","Will Not Cross Running Water at Night - Superstition With a Basis","Their Conscience Takes Up Space They Cannot Afford","The Dog Tags Around Their Neck Are From Three Different People","Known Informant - Former, But the Reputation Persists","Too Proud to Take Charity Even When They Need It","The Signal Their Implant Emits Can Be Tracked","The Code They Were Given Before the Collapse Still Runs","Symptoms Managed Three Weeks - Supply Calculated to the Day","The Condition Requires Silence to Manage and That Is Not Always Available","One Daily Practice Keeps the Dark Back - Supply Is Short","Carries Something Worthless Except It Would Break Them","Proximity to Violence Costs Them What It Costs Their Target","Every Death on Their Routes Added to an Internal Ledger","Their Appearance Marks Them as Something the Wrong Faction Shoots on Sight","Unique Skill With No Successor - Never Taught Anyone","Carrying Something Factions Would Kill For - Won't Trade","Can't Stay Still Without Mapping Every Exit - Visible","Requires an Audience for Risk - Will Escalate to Create One","Origin Community Killed on Sight in Three Territories","Scar from the Third Year - Never Healed, Still Opens","Relationship With Scarcity Set Too Early - Never Recalibrated","Afraid of What They'd Ask For If They Found It","Most Important Gear Is Visible - and Always Targeted","The Animal They Travel With Is Perfect Leverage","The Cache Is the One Thing They Can't Think Clearly About","Has Not Grieved Either World and the Backlog Is Structural","Community Brand Identifies Them to Anyone Who Knows It","Carrying Something That Was a Child's - Child Didn't Make It","My Immunity Makes Others Desperate Enough to Consider Taking It by Force","Know the Toxic Zone Route - Can't Share How","Teaching Someone Better Than Me - Running Out of Time","The Settlement's Food Supply Depends on a Secret Nobody Else Can Know","Cannot Pass a Child in Distress - Not Once","Still Carry the Book Despite What It Would Trade For","The Bloom Is Three Miles Closer - Not Told Anyone","Know What's in the Vault and Why It Stays There","Voice Carries - Makes Every Quiet Place Dangerous","I Made the Call That Burned the Last Settlement","Won't Abandon a Viable Seed - Even in a Firefight","What the Medicine Is For Would Change How They See Me","Was a Prophet's Second - The Followers Still Find Me","Saved One Person and Ended Everyone Else's Options","Exposure Schedule Past the Point of Useful Denial","The Route Goes Through Territory I Cannot Enter","One Thing I Won't Eat - No Matter How Long the Road","Seen What Hope Does to People - Won't Be That","Hands Steady Until Safe - Then They Shake"],
      major_concepts: {
          t: [
      ...
      troubles: [
        ...
        "Someone Else Knows What I Did to Survive Before",
        ...
        "The Addiction Gets Me Through the Night",
        ...
        "Already Irradiated - This Trip Accelerates the Schedule",
        "I Was the Reason That Settlement Burned",
        ...
        "I Know the Name of the Person Who Destroyed My Settlement — They're Three Days Ahead of Me",
        "The Code I Know Would Change Everything - If I Used It",
        "Built for the Old World - Wrong Shape for the New",
        "Three Settlements Call Me Their Leader and None Know About the Others",
        "Kept One Person Alive at Cost to Everyone Else",
        "Vault Find That Cannot Be Used or Destroyed",
        "There Is a Community That Thinks I'm Coming Back to Lead Them",
        "Know Where the Pre-War Cache Is - Can't Tell",
        "The Map I'm Following Was Made by Someone Who Didn't Survive the Route",
        "Building Something That Outlasts Me - Every Day Is a Cost",
        "The Pre-War ID in My Pack Belongs to Someone Who Might Still Be Alive",
        "Survival Isn't Enough - Can't Convince Anyone, Including Me",
        "What I'm Protecting Is Both the Cure and the Threat",
        "Know the Safe Path - Can't Share It Without Everything",
        "Preserving Knowledge I Don't Understand - Nobody Else Is",
        "Responsible for the One Person Who Cannot Die",
        "Know What the Vault Was Testing - My People Were Variables",
        "Know What This Knowledge Does Wrong - Carry It Anyway",
        "Last One Who Remembers How It Was Done",
        "Enforced the Water Rules - Not Everyone Survived the Season",
        "I Know Where the Food Comes From - So Does Everyone",
        "I Have Broken the Rule That Keeps My Community Safe",
        "Told Them It Was Safe - Right and Wrong - People Died",
        "What I Am Would End My Place Here - Community Correct",
        "Read the Pre-War Record of This Region - Can't Forget",
        "Won't Use the Pre-War Weapon - Haven't Said Why",
        "Know Where the Green Place Is - Not Telling Yet",
        "Enough Medicine for the Community or the Road - Chose"
      ...
      stunts: [
        {name:"Scavenger's Eye",skill:"Notice",desc:"+2 to overcome when searching ruins, vehicles, or abandoned structures for useful materials.",type:"bonus",tags:["investigation", "knowledge", "survival"]},
        {name:"Wasteland Navigation",skill:"Lore",desc:"+2 to overcome when navigating by landmarks, sun position, or pre-war maps across open terrain.",type:"bonus",tags:["movement", "survival", "knowledge"]},
        {name:"Field Surgery",skill:"Crafts",desc:"+2 to overcome when treating injuries with improvised equipment or limited supplies.",type:"bonus",tags:["repair", "survival", "knowledge"]},
        {name:"Threat Assessment",skill:"Notice",desc:"+2 to create advantages representing tactical evaluation of a group, position, or settlement's defences.",type:"bonus",tags:["investigation", "knowledge", "combat"]},
        {name:"Road Fighter",skill:"Fight",desc:"+2 to attack when fighting in the open: roads, open ground, or unstructured terrain.",type:"bonus",tags:["combat", "survival"]},
        {name:"Scrap Engineering",skill:"Crafts",desc:"+2 to overcome when building, repairing, or modifying pre-war technology with post-war materials.",type:"bonus",tags:["repair", "technical", "survival"]},
        {name:"Long Road Contacts",skill:"Contacts",desc:"+2 to overcome when calling on favours from settlements, trading posts, or road groups along known routes.",type:"bonus",tags:["social", "knowledge", "negotiation"]},
        {name:"Two-Step",skill:"Deceive",desc:"+2 to overcome when running a con, misdirection, or false identity in a community that hasn't seen many outsiders.",type:"bonus",tags:["subterfuge", "movement", "social"]},
        {name:"Dead Shot",skill:"Shoot",desc:"+2 to attack when you have time to aim and the target hasn't moved this exchange.",type:"bonus",tags:["combat"]},
        {name:"Survival Instinct",skill:"Athletics",desc:"+2 to defend against environmental hazards: radiation, extreme heat, poison, and physical traps.",type:"bonus",tags:["survival", "movement", "combat"]},
        {name:"Last Round",skill:"Shoot",desc:"Once per scene, make one attack with a weapon you've declared empty or broken - it works, once, then it's genuinely gone.",type:"special",tags:["combat", "survival"]},
        {name:"Shake It Off",skill:"Physique",desc:"Once per scene, clear your lowest filled stress box as a free action after taking physical damage.",type:"special",tags:["survival", "combat"]},
        {name:"Cache Memory",skill:"Lore",desc:"Once per scene, declare that you hid supplies at this location during a prior journey - food, medicine, ammunition, or fuel.",type:"special",tags:["knowledge", "survival", "investigation"]},
        {name:"Fear of the Wastes",skill:"Provoke",desc:"Once per scene, your reputation or demeanour causes all minor NPCs in the zone to hesitate - they cannot act this exchange unless attacked first.",type:"special",tags:["intimidation", "survival", "social"]},
        {name:"Jury Rig",skill:"Crafts",desc:"Once per scene, make a piece of broken equipment functional for one scene - no roll, but it doesn't survive beyond this use.",type:"special",tags:["repair", "technical", "survival"]},
        {name:"Read the Settlement",skill:"Empathy",desc:"Once per scene, identify the single greatest tension or secret in a community you've spent at least one hour in.",type:"special",tags:["social", "investigation", "knowledge"]},
      {name:"Eagle Eye",skill:"Notice",desc:"+2 to Notice when spotting movement in the wastes.",type:"bonus",tags:["investigation", "combat", "movement"]}, {name:"Ghost of the Wastes",skill:"Stealth",desc:"+2 to Stealth when in ruins or open desert.",type:"bonus",tags:["stealth", "movement", "survival"]}, {name:"Hard-Bargainer",skill:"Resources",desc:"+2 to Resources when trading for water or fuel.",type:"bonus",tags:["negotiation", "social", "intimidation"]}, {name:"Intimidating Scar",skill:"Provoke",desc:"+2 to Provoke against other survivors.",type:"bonus",tags:["intimidation", "social", "combat"]}, {name:"Hotwire",skill:"Crafts",desc:"Once per scene, start, bypass, or disable any vehicle or powered pre-war device without the proper access credentials.",type:"special",tags:["repair", "technical", "survival"]}, {name:"Herbalist",skill:"Lore",desc:"+2 to overcome when identifying, preparing, or substituting natural medicines, poisons, or nutritional sources in the wastes.",type:"bonus",tags:["repair", "technical", "knowledge"]}, {name:"Rad-Resistant",skill:"Physique",desc:"+2 to Physique when resisting environmental radiation.",type:"bonus",tags:["survival", "knowledge"]}, {name:"Trade Route Knowledge",skill:"Lore",desc:"+2 to overcome when planning a route between settlements, estimating travel time, or knowing what conditions a road currently holds.",type:"bonus",tags:["combat", "survival", "technical"]}, {name:"Warning Shot",skill:"Shoot",desc:"+2 to Create Advantage when firing to intimidate, herd, or deter rather than to kill — the aspect lands without requiring a hit.",type:"bonus",tags:["combat"]}, {name:"Survivor's Luck",skill:"Will",desc:"Once per session re-roll a failed defense roll.",type:"special",tags:["survival", "combat", "subterfuge"]},
        {name:"Ambush Predator",skill:"Stealth",desc:"+2 to Create Advantage when setting up an ambush or preparing a kill zone before an encounter begins.",type:"bonus",tags:["stealth", "movement", "survival"]},
        {name:"Wasteland Navigator",skill:"Drive",desc:"+2 to Drive when traveling off-road.",type:"bonus",tags:["movement", "knowledge", "survival"]}],
      scene_tone: {
          t: [
            "{PtAdj} and {PtAdj2}",
            "{PtNoun}-heavy {PtQual}",
      ...
      scene_danger: {
          ...
          v: {
            ...
            PdHazard: ["collapse zone", "rad contamination", "booby-trapped scavenge site", "warlord kill zone", "contaminated water source", "pipe bomb cache", "defence grid", "chemical storage drums", "pressurised fuel line", "trap array"],
