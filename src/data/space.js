...
export const CAMPAIGNS = { space: {
    ...
    tables: {
      ...
      {name:"Hard Burn",skill:"Drive",desc:"+2 to overcome when racing against a deadline — pursuit, intercept, or transit under time pressure.",type:"bonus",tags:["movement", "technical", "combat"]}, {name:"Babel Fish",skill:"Lore",desc:"+2 to Lore when deciphering alien languages.",type:"bonus",tags:["social", "knowledge", "negotiation"]}, {name:"Evasive Thrust",skill:"Drive",desc:"Once per scene swap your position with any other ship in a chase without a roll.",type:"special",tags:["movement", "combat", "technical"]}, {name:"Intimidating Presence",skill:"Provoke",desc:"+2 to Provoke when dealing with low-life pirates.",type:"bonus",tags:["intimidation", "social", "leadership"]}, {name:"Long-Range Scanner",skill:"Notice",desc:"+2 to Notice when detecting cloaked ships.",type:"bonus",tags:["investigation", "technical", "knowledge"]}, {name:"Crew Loyalty",skill:"Rapport",desc:"+2 to Create Advantage when rallying your own crew in a moment of crisis or mutiny.",type:"bonus",tags:["social", "negotiation", "knowledge"]}, {name:"Overcharge Shields",skill:"Crafts",desc:"Once per scene give your ship a 2-point armor soak.",type:"special",tags:["technical", "combat", "survival"]}, {name:"Political Savvy",skill:"Contacts",desc:"+2 to Contacts when dealing with planetary governments.",type:"bonus",tags:["social", "negotiation", "leadership"]}, {name:"Quick Draw",skill:"Shoot",desc:"Use Notice instead of Shoot to determine who fires first.",type:"special",tags:["combat", "movement"]}, {name:"Scrounge",skill:"Resources",desc:"Use Resources to find rare ship parts in junkyards.",type:"special",tags:["survival", "technical", "knowledge"]},
        {name:"Salvage Expert",skill:"Crafts",desc:"+2 to Create Advantage when stripping or repurposing equipment from a derelict, wreck, or abandoned station.",type:"bonus",tags:["repair", "technical", "knowledge"]},
