...
// FaFileArrowDownIcon — file-arrow-down (FA fa-file-arrow-down)
function FaFileArrowDownIcon(props) {
  var sz = props.size || 14;
  return h('svg', {
    ...
    h('path', {d: 'M320 464c8.8 0 16-7.2 16-16l0-288-80 0c-17.7 0-32-14.3-32-32l0-80L64 48c-8.8 0-16 7.2-16 16l0 384c0 8.8 7.2 16 16 16l256 0zM0 64C0 28.7 28.7 0 64 0L229.5 0c17 0 33.3 6.7 45.3 18.7l90.5 90.5c12 12 18.7 28.3 18.7 45.3L384 448c0 35.3-28.7 64-64 64L64 512c-35.3 0-64-28.7-64-64L0 64zm176 200l0-64c0-13.3 10.7-24 24-24s24 10.7 24 24l0 64 32 0c9.2 0 17.4 5.4 21.2 13.8s2.2 18.2-4.2 24.9l-56 64c-4.5 5.1-11 8.1-17.9 8.1s-13.4-3-17.9-8.1l-56-64c-6.4-6.6-8.1-16.4-4.2-24.9s12-13.8 21.2-13.8l32 0z'})
  );
}

// FaFileArrowUpIcon — file-arrow-up (FA fa-file-arrow-up)
function FaFileArrowUpIcon(props) {
  var sz = props.size || 14;
  return h('svg', {
    xmlns: 'http://www.w3.org/2000/svg', viewBox: '0 0 384 512',
    width: sz, height: sz, fill: 'currentColor',
    ...
    h('path', {d: 'M320 464c8.8 0 16-7.2 16-16l0-288-80 0c-17.7 0-32-14.3-32-32l0-80L64 48c-8.8 0-16 7.2-16 16l0 384c0 8.8 7.2 16 16 16l256 0zM0 64C0 28.7 28.7 0 64 0L229.5 0c17 0 33.3 6.7 45.3 18.7l90.5 90.5c12 12 18.7 28.3 18.7 45.3L384 448c0 35.3-28.7 64-64 64L64 512c-35.3 0-64-28.7-64-64L0 64zm152 150.3l0 93.7c0 13.3 10.7 24 24 24s24-10.7 24-24l0-93.7 32 0c9.2 0 17.4-5.4 21.2-13.8s2.2-18.2-4.2-24.9l-56-64c-4.5-5.1-11-8.1-17.9-8.1s-13.4 3-17.9 8.1l-56 64c-6.4 6.6-8.1 16.4-4.2 24.9s12 13.8 21.2 13.8l32 0z'})
  );
}
...
// Catches errors thrown during render, lifecycle, or child tree effects.
// Displays a recovery UI instead of a blank white page.
// Usage: h(ErrorBoundary, {label: 'optional context'}, h(CampaignApp, {...}))
// Note: must be a class component — hooks cannot catch render errors.
class ErrorBoundary extends React.Component {
  ...
  componentDidCatch(error, info) {
    // Store component stack for debug display
    this.setState({ info: info });
    // Log to console for devtools — not a user-visible action
    console.error('[Ogma ErrorBoundary]', this.props.label || '', error, info);
  }
  ...
  render() {
    ...
    var label = this.props.label || 'component';

    return h('div', {
      style: {
        padding: '32px 24px', maxWidth: 520, margin: '60px auto',
        fontFamily: 'var(--font-ui, monospace)',
        background: 'var(--panel-raised, #1a1a2e)',
        border: '1px solid var(--c-red, #e05)',
        borderRadius: 10,
        color: 'var(--text, #eee)',
      },
    },
      h('div', {style: {fontSize: 22, fontWeight: 700, marginBottom: 8}},
        '\u26A0\uFE0F Something went wrong'
      ),
      h('p', {style: {fontSize: 13, color: 'var(--text-muted, #aaa)', marginBottom: 16}},
        'An error occurred in the ' + label + '. ' +
        'Your session data is safe — try rolling again or refreshing.'
      ),
      h('pre', {
        style: {
          fontSize: 11, padding: '10px 12px', borderRadius: 6, overflowX: 'auto',
          background: 'rgba(0,0,0,.35)', color: 'var(--c-red, #e05)',
      ...
      h('div', {style: {display: 'flex', gap: 10}},
        ...
        h('button', {
          onClick: function() {
            // Clear session IDB state and reload — useful if corrupt data caused the crash
            if (window.DB && window.DB.clearSession) {
              window.DB.clearSession('run_session_v2')
                .catch(function(){})
