...
CAMPAIGNS["postapoc"] = {
    ...
    tables: {
      ...
      troubles: [
        ...
        "Cannot Stop Keeping One Person Alive - Can't Justify It",
        "Building Something That Outlasts Me - Every Day Is a Cost",
        "I Chose One Person Over Everyone's Future - Would Again",
      ...
      {name:"Eagle Eye",skill:"Notice",desc:"+2 to Notice when spotting movement in the wastes.",type:"bonus",tags:["investigation", "combat", "movement"]}, {name:"Ghost of the Wastes",skill:"Stealth",desc:"+2 to Stealth when in ruins or open desert.",type:"bonus",tags:["stealth", "movement", "survival"]}, {name:"Hard-Bargainer",skill:"Resources",desc:"+2 to Resources when trading for water or fuel.",type:"bonus",tags:["negotiation", "social", "intimidation"]}, {name:"Intimidating Scar",skill:"Provoke",desc:"+2 to Provoke against other survivors.",type:"bonus",tags:["intimidation", "social", "combat"]}, {name:"Jury-Rig",skill:"Crafts",desc:"Once per scene repair a broken device instantly for one use.",type:"special",tags:["repair", "technical", "survival"]}, {name:"Makeshift Mechanic",skill:"Crafts",desc:"+2 to overcome obstacles using damaged or scrap technology.",type:"bonus",tags:["repair", "technical", "knowledge"]}, {name:"Rad-Resistant",skill:"Physique",desc:"+2 to Physique when resisting environmental radiation.",type:"bonus",tags:["survival", "knowledge"]}, {name:"Scrapper",skill:"Crafts",desc:"+2 to Crafts when building items from junk.",type:"bonus",tags:["combat", "survival", "technical"]}, {name:"Sure Shot",skill:"Shoot",desc:"+2 to Shoot when using bolt-action rifles.",type:"bonus",tags:["combat"]}, {name:"Survivor's Luck",skill:"Will",desc:"Once per session re-roll a failed defense roll.",type:"special",tags:["survival", "combat", "subterfuge"]},
        {name:"Wasteland Ghost",skill:"Stealth",desc:"+2 to defend with Stealth when in open ruined landscapes.",type:"bonus",tags:["stealth", "movement", "survival"]},
