...
CAMPAIGNS["victorian"] = {
    ...
    tables: {
      ...
      minor_weaknesses: ["The Thing They Saw Has Not Left Them","Blackmailed Into This Position","Addicted to Laudanum or Something Worse","Their Employer Would Destroy Them if They Talked","The Faith They Had Is Gone and They Know It","One Act of Conscience Away from Ruin","Family Name Carries a Darker History Than They Admit","The Creature Marked Them — They Don't Know It Yet","They've Already Told Someone Where They Are","Guilt Over the Last Person Who Trusted Them","The Blackmail Material Is Real and Extremely Specific","Gambling Debts Owed to a Particularly Persistent Creditor","Their Name Appears in the Lodge's Membership Rolls — Accurately","The Addiction Is Under Control Until It Suddenly Isn't","A Prior Conviction That Complicates All Encounters With Law","They Cannot Bring Themselves to Betray a Confidence","The Creature Left a Mark That Flares Near Its Kind","Family Obligation Requires Weekly Attendance — Inconvenient","Their Own Testimony Implicates Them in a Prior Incident","Will Not Leave a Witness — But Cannot Harm One Either","Aversion to the Dark Since the Incident in the Cellar","Reputation for Eccentricity Means Nobody Takes Them Seriously","The Medicine Is Necessary and Controlled by the Wrong Doctor","Compulsive Need to Document Everything — Including This","Recognisable to Every Constable in a Five-Mile Radius","Old Family Shame That Surfaces at Social Functions","Cannot Enter a Church Since the Vision","Owes a Debt to the Society That Cannot Be Repaid In Money","The Thing They Carry Wants to Be Found","Terrified of Mirrors Since Whitechapel","Cannot Stand Confined Spaces Since the Vault — The Terror Beneath the Church Still Registers","The Sight Opens Without Warning Near the Dying — Inconvenient, Unreliable, Unchosen","Bound by an Oath to the Lodge Taken Before Understanding What the Lodge Actually Is","Will Not Permit a Dissection — Personal Reasons More Complex Than They Sound","Their Handwriting Changes When the Other Thing Writes Through Them — They Do Not Always Notice","Owes a Debt to Something Old That Collects Interest in Currencies Other Than Money","The Newspaper Has Their Face and Uses It Whenever a Story Becomes Inconvenient","The Locket Never Removed Is Not Theirs and Is Not Empty","Their Name in the Lodge's Black Register Means Any Member May Call on Them by Right","Compelled to Complete Any Ritual Witnessed in Progress — Cannot Leave the Working Unfinished","The Scar Itches Near the Entity — Useful Proximity Warning, Unwanted Proximity Detector","Laudanum Was the Only Reliable Veil Over the Visions — Now the Required Dose Increases","The Colonial Artefact Carried Has an Original Owner Who Is Still Looking for It","Will Not Enter a Room Without First Mapping the Exits — Creates Social Difficulties","Their Scientific Reputation Means Any Claim of Supernatural Experience Is Professionally Suicidal","Estranged From the Church But Still Bound by Old Promises Made in Extremis","The Creature Shown Mercy Has Not Forgotten — and Does Not Distinguish Mercy from Ownership","The Lodge Holds Something About Them That Their Allies Do Not and Has Not Yet Chosen to Use It","The Weather Responds to Their Emotional State in a Small But Demonstrable Radius","Their Most Dangerous Knowledge Is Also Their Most Published — Denial Is Now Publicly Documented"],
      major_concepts: {
          t: [
      ...
      troubles: ["The Lodge Has Eyes in Every Institution","My Research Has Gone Further Than I Can Come Back From","I Know What Took My Friend and I Cannot Say It","The Creature Left Something In My Mind","My Good Name Is the Only Armour I Have Left","I Have Made Compacts I Cannot Undo","The Case That Destroyed My Career Won't Stay Closed","I Believe Everything I've Seen — and That Terrifies Me","My Family Must Never Know What I've Become","The Madness Comes in Waves and the Tide Is Coming","The Addiction Owns Me Body and Soul — I Just Manage It","Something Has Been Hunting Me Longer Than I Have Known","The Corruption Runs Deeper Than Any Audit Could Find","My Notorious Past Travels Faster Than I Do","I Will Not Let This Wrong Go Unpunished, Not Even at Total Cost","The Indebted Never Truly Get Free — They Just Change Creditors","The Lodge Has My Signature on Something I Cannot Repudiate","I Have Seen Through the Veil and It Has Seen Through Me","The Evidence Proves Everything and Convicts Me Equally","My Rational Framework Cannot Accommodate What I Have Witnessed","The Creature Has Taken an Inappropriate Interest in My Research","I Have Made Promises to the Dead That I Must Now Keep","The Society Considers My Knowledge a Liability to Be Managed","Every Investigation Leads Back to the Same Name","The Medicine That Controls the Condition Is Running Out","My Social Position Requires I Deny What My Eyes Have Confirmed","I Was In That Room When It Happened — Nobody Believes My Account","The Record Shows I Was Somewhere I Was Not — Someone Arranged This","I Am Being Followed by Something That Learns My Patterns","Three Months of Memory Are Gone — Selectively Gone","The Thing That Came Through Needed Me Specifically to Open It","I Have Not Told My Partner What I Know — For Their Safety","The Entity Made an Offer Through the Séance and I Did Not Say No Clearly Enough","The Thing That Occasionally Writes Through My Hand Has Better Instincts Than I Do","My Obsession Has Consumed Every Friendship and I Am Close to Understanding Why That Was Necessary","The Compact My Ancestor Signed Is Still Active and Has Located the Current Generation","I Was in the Ice When It Found Us and I Am the Only One Who Came Back","The Knowledge I Carry Was Not Freely Given and What Gave It Is Still Owed","I Have Been Somewhere Time Does Not Run Correctly and I Am Not Certain I Am Entirely Back","The Architecture Has Been Speaking to Me and I Have Begun Speaking Back","The Creature I Made Knows Where I Am and Has Not Yet Decided What to Do About That","The Dreams Show Me What Happens Before It Happens and I Have Not Found a Way to Be Wrong","The Entity Calls Me by the Name I Have Never Told Anyone","I Can Hear the City's Dead and the City Has Many Dead and They Are Not All Quiet About It","My Double Has Been Seen in Places I Have Not Been and Doing Things I Have Not Done","My Published Theories Are Correct and If Anyone Reads Them Carefully We Are All in Danger","The Empire Brought Something Back That Knows My Family's Name Before Mine","The Magic Runs in My Blood and Costs Something I Cannot Quantify and Has Not Stopped Costing","Three People Are Dead Directly Because I Did Not Act on What I Already Knew","The Thing That Looks Like My Reflection Has Stopped Following My Movements Exactly"],
      other_aspects: {
          t: [
            "{VOAdj} in {VOSphere}",
      ...
      stunts: [
        {name:"Deductive Mind",skill:"Investigate",desc:"+2 to create advantages when observing a person or crime scene with at least one minute of study.",type:"bonus"},
        {name:"Society Connections",skill:"Contacts",desc:"+2 to overcome when seeking information within the upper classes, clubs, or government institutions.",type:"bonus"},
        {name:"Street Knowledge",skill:"Contacts",desc:"+2 to overcome when seeking information from the criminal underworld, dockworkers, or lower city.",type:"bonus"},
        {name:"Iron Nerve",skill:"Will",desc:"+2 to defend against the mental stress of witnessing supernatural events, aberrant phenomena, or profound horror.",type:"bonus"},
        {name:"Occult Library",skill:"Lore",desc:"+2 to overcome when researching arcane texts, identifying occult symbols, or recognising ritual patterns.",type:"bonus"},
        {name:"Pugilist",skill:"Fight",desc:"+2 to attack with Fight when your opponent is unarmed or smaller than you.",type:"bonus"},
        {name:"Disguise",skill:"Deceive",desc:"+2 to overcome when adopting a false identity in a social class you have personally observed closely.",type:"bonus"},
        {name:"The Listening City",skill:"Notice",desc:"+2 to overcome when gathering information by eavesdropping in public spaces.",type:"bonus"},
        {name:"Steady Hand",skill:"Shoot",desc:"+2 to attack when you have at least one exchange to aim and the target is not aware of you.",type:"bonus"},
        {name:"Medical Training",skill:"Crafts",desc:"+2 to create advantages or remove complications related to physical injury or poisoning.",type:"bonus"},
        {name:"Psychic Barrier",skill:"Will",desc:"Once per scene, force a supernatural entity to make a Will overcome roll to target you mentally — on a fail, it cannot affect you this scene.",type:"special"},
        {name:"On the Case",skill:"Investigate",desc:"Once per scene, ask the GM one yes/no question about a crime, scene, or person you've been able to observe for at least a few minutes.",type:"special"},
        {name:"Face in the Crowd",skill:"Stealth",desc:"Once per scene, become completely unnoticeable in a crowd — witnesses will not recall you were present, no roll required.",type:"special"},
        {name:"Invoking the Compact",skill:"Rapport",desc:"Once per scene, call upon a formal agreement, debt, or oath held over an NPC to demand a single specific action from them.",type:"special"},
        {name:"Exorcism Rite",skill:"Lore",desc:"Once per scene, begin a ritual that, if uninterrupted for one exchange, suppresses or drives off a supernatural entity present in the zone.",type:"special"},
        {name:"Read the Room",skill:"Empathy",desc:"Once per scene, identify the single most useful hidden motivation of an NPC you're currently speaking with — the GM must answer honestly.",type:"special"},
      {name:"Anatomist",skill:"Fight",desc:"Use Investigate instead of Fight when targeting a creature's weak point.",type:"special"}, {name:"Deduction",skill:"Investigate",desc:"Use Investigate instead of Empathy to spot a lie.",type:"special"}, {name:"Deductive Leap",skill:"Investigate",desc:"Once per scene, automatically discover one hidden clue or concealed fact without a roll — the GM must answer honestly.",type:"special"}, {name:"Forbidden Rites",skill:"Lore",desc:"Use Lore to attack an entity from beyond the veil as if it were a physical weapon.",type:"special"}, {name:"Gadgeteer",skill:"Crafts",desc:"Once per scene produce a specialized tool for the task at hand.",type:"special"}, {name:"Grim Resolve",skill:"Physique",desc:"+2 to Physique when resisting poison or disease.",type:"bonus"}, {name:"Iron Will",skill:"Will",desc:"+2 to Will when defending against mental corruption.",type:"bonus"}, {name:"Occult Knowledge",skill:"Lore",desc:"+2 to Lore when identifying eldritch rituals.",type:"bonus"}, {name:"Shadow-Stalker",skill:"Stealth",desc:"+2 to Stealth when in thick fog or darkness.",type:"bonus"}, {name:"Silver-Tongue",skill:"Rapport",desc:"+2 to Rapport when dealing with the upper class.",type:"bonus"},
        {name:"Duelist's Aim",skill:"Shoot",desc:"+2 to Shoot when using flintlock or steam-powered pistols.",type:"bonus"},
        {name:"Underworld Contacts",skill:"Contacts",desc:"+2 to Contacts when searching for illicit information.",type:"bonus"}],
      scene_tone: {
          t: [
            "{VtAdj} and {VtAdj2}",
            "{VtNoun}-heavy {VtQual}",
          ...
          v: {
            VtAdj: ["Gaslit", "Fog-wrapped", "Oppressively civil", "Class-stratified", "Supernaturally charged", "Scandal-adjacent", "Evidentially rich", "Formally hostile", "Occultly active", "Impeccably maintained", "Eldritch-charged", "Colony-returned", "Veil-thin", "Psychically-active", "Lodge-saturated"
            ],
            VtAdj2: ["watched from behind correct manners", "thick with what isn't being said", "loaded with implications nobody will state", "carrying a secret toward the surface", "two social exchanges from crisis", "perfectly maintained and deeply wrong", "watching every exit", "waiting for someone to name what everyone knows", "thin over something significant", "wrong in exactly one detail", "carrying something that came home from somewhere it shouldn't have been brought", "thin over something that has been building for decades", "wrong in a way that Lore confirms and reason contests", "holding very still in the way things hold still before they act"
            ],
            VtNoun: ["Scandal", "Fog", "Propriety", "Evidence", "Class", "Secrecy", "Society", "Gas"],
            ...
            VtAir: ["thick with the unsaid", "wrong in a way instruments can't measure", "heavy with old money and older secrets", "carrying something from the floor below", "perfumed over something it shouldn't cover", "carrying the particular smell of something not from this city", "wrong in a measurable way that no instrument will confirm officially"
            ],
            VtSurface: ["a potential witness", "carrying evidence", "watching without appearing to", "wrong in one specific detail", "placed by someone who wasn't supposed to be here", "touched since this morning in a pattern that suggests purpose", "precisely as it was left and precisely not as it should be"
            ],
          }
        },
      ...
      scene_danger: {
          ...
          v: {
            VdAdj: ["Unstable", "Supernatural", "Undocumented", "Occult", "Volatile", "Pre-ritual", "Classified", "Recently disturbed", "Chemically", "Structurally"],
            VdHazard: ["ritual circle mid-activation", "supernatural entity at threshold", "unstable chemical compound", "structural weakness in old stonework", "classified document within reach", "occult ward pattern", "evidence that changes everything", "gas leak under pressure", "summoning residue", "a presence that shouldn't be here"],
            ...
            VdMagic: ["summoning circle", "ward sequence", "medium channel", "ley convergence", "occult compact", "active manifestation"],
...
t.scene_tone.v.VtAdj = t.scene_tone.v.VtAdj.concat([
  ...
  "gin-soaked", "horse-dung pungent", "fog-muffled", "gaslit-flickering",
]);
