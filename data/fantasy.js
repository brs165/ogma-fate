...
CAMPAIGNS["fantasy"] = {
    ...
    tables: {
      ...
      minor_concepts: {
          ...
          v: {
            FmAdj: ["desperate", "fanatical", "loyal", "corrupt", "frightened", "brutish", "cunning", "hollow-eyed", "well-armed", "enspelled", "dishonoured", "mercenary", "blight-touched", "oathless", "war-maddened", "consecrated", "starving", "ancient-bound", "twice-dead", "hollow-eyed", "spell-scarred", "rootless"
            ],
      ...
      minor_weaknesses: ["Haunted by the War That Never Ended","Cursed — Something Has Claim on Their Soul","Owes a Tithe They Cannot Pay","The Old Wound Opens When It Matters Most","Bound by an Oath to the Wrong Lord","Terrified of Magic After What They Saw","Only Following Orders — Barely","Will Not Harm a Child, No Matter What","Their Gods Have Abandoned Them and They Know It","Loyalty to One Person, Not the Cause","The Old Oath Still Holds and They Know It","Terrified of the Undead — Saw Too Many Rise","Cursed Blade Compels Use When Blood Is Near","The God Is Watching — Disobedience Has Consequences","Wanted in the Capital for Something They Actually Did","Will Not Strike an Unarmed Opponent","Deep Superstition About Owls — Will Not Move After Midnight","The Old Wound Costs Them When the Cold Comes","Owes Fealty to a House That Should Have No Claim","Can't Resist a Direct Bet — Pride Over Sense","Known to the Inquisition by Face and Reputation","Addicted to the Alchemist's Compound Since the War","Compelled to Confess Under Magical Interrogation","Their Name Appears in the Prophecy — They've Read It","Cannot Bear to See a Child Suffer — Will Act Without Thinking","The Magic Costs More Than They Admit","Bound by a Geas They Did Not Consent To","Family Honour Requires Vengeance They Cannot Afford","Terrified of Deep Water After the River Crossing","The Enemy Knows Their Real Name","The Old Magic Calls to Them Physically — They Have to Fight Not to Answer","Cannot Strike the First Blow, Ever, Under Any Circumstances — the Oath Holds","Will Perform Last Rites for Any Fallen, Enemy or Not — Cannot Leave Without It","Known to the Undead by Sight — They Part For the Character Instead of Attacking","The Scar Is Magical and Reacts to Old Workings — a Living Compass, Unwanted","Bound by Hospitality Law — Cannot Refuse a Guest Meal or Shelter","Speaks Truthfully Under the Old Sky — Lying After Dusk Causes Physical Pain","Will Not Burn a Forest, Whatever Else Happens","The Blood Price on Their Head Is Old and Still Valid Under Three Nations' Law","Their True Name Was Carved in the Black Archive — Someone Has the Book","Cannot Refuse the Direct Plea of a Child — Every Enemy Has Learned This","The Weapon Will Not Strike a Surrendering Foe — The Enchantment Overrides the Hand","The Blight Sickness Is Held Back But Not Gone — Cold or Hunger Can Break the Hold","Cursed to Dream True Dreams That Come Before Morning — Sleep Is Rarely Restful","Owes Tithe to the Forest — Has Been Postponing It for Three Seasons","The God They Abandoned Sends Them Signs Regardless — Ignoring Them Is Getting Harder","Professional Pride Requires They Never Admit the Magic Is Beyond Them — It Has Been Three Times","Cannot Enter Consecrated Ground of the Old Faith Without Pain","The Title Compels Certain Conduct in Public — They Have Not Resigned It","Whatever They Did in the War Is Still Classified By Three Parties — Two of Them Hostile"],
      major_concepts: {
          t: [
      ...
      troubles: ["Every Kingdom I Serve Eventually Falls","The Magic Is Burning Out of Me","I Made a Bargain I Cannot Undo","There Are People Alive Because I Lied to Them","The Crown Wants Me Dead and the Crown is Right","My Power Comes at a Cost That Isn't Mine to Pay","I Cannot Kill the Person I Need To","The Prophecy Names Me and I Refuse It","Honour Has Cost Me Everyone","The God I Serve Has Other Plans","The Prophecy Has My Name In It and I Cannot Walk Away","I Made a Pact With Something That Always Collects What It Is Owed","The Curse Was Supposed to Protect Others — I Should Have Read It First","My Ambition Has Burned Every Bridge I Ever Crossed to Get Here","I Was Chosen by the Wrong God for a Purpose I Don't Understand","The Enemy I Could Not Kill Is Still Out There — and Still Patient","The Magic Chose Me at Birth and Has Never Asked My Opinion Since","Everything I Build Eventually Serves the Prophecy I Refuse","The Cursed Blade Whispers and I Have Started Listening","I Was the Weapon — I Don't Know What I Am When There's No War","The God I Serve and I Disagree on Methodology","My Bloodline Opens Doors I Would Rather Keep Closed","There Are People Alive Because of Terrible Things I Did","The Old Kingdom's Laws Still Apply to Me","I Am the Thing the Old Stories Warned About","The Enemy I Could Not Kill Returns Stronger Each Time","Every Ally I Gain Becomes a Target of My Enemies","The Magic Leaves Something Behind Each Time I Use It","My True Name Is Known to the Wrong Entity","I Won the War and Lost Everything I Fought It For","The Crown Has a Legal Claim on My Service I Cannot Contest","I Have Seen What Happens at the End — and It Includes Me","The Magic Left Something Inside Me When It Passed Through","Every Kingdom I Helped Build Has Since Burned","The God I Stopped Believing In Has Not Stopped Believing in Me","The Old Compact Still Binds My Bloodline Whether I Accept It or Not","I Know What Is Inside the Sealed Vault and I Cannot Tell Anyone","The Curse Passes to Whoever Kills Me — I Have Stopped Being Able to Die","The Dead Army I Led Through the Pass Is Still Out There and Still Following","I Was the Last One to Hold the Ritual and I Did It Wrong","My Power Grows With My Despair and I Am Running Out of Reasons to Be Hopeful","The Prophecy Was Written About Me by Someone Who Hated Me and It Is Still Coming True","I Serve a Dead King Whose Commands Were Never Rescinded","The Magic Recognised Something in Me That I Have Spent My Life Denying","I Was the Weapon Used in the War — the War Is Over and I Am Still Sharp","Everything I Have Built Will Eventually Be Used Against the People I Built It For","The Three Courts All Have Legitimate Claim on My Loyalty and None of Them Know About the Others","The Scar Where the Spell Exited Has Been Growing for Four Years","I Know How the Age Ends — I Was There the Last Time This Happened","I Broke an Oath to the Old Gods and They Have Been Quiet About It Which Is Worse Than Anger","The Creature I Spared Survived Precisely Because I Spared It and Is Now a Problem","I Remember the Kingdom Before the Cataclysm and Everything Since Has Been a Disappointment"],
      other_aspects: {
          t: [
      ...
      stunts: [
        {name:"Shield Wall",skill:"Fight",desc:"+2 to defend when protecting an adjacent ally in the same zone.",type:"bonus"},
        {name:"Arcane Reading",skill:"Lore",desc:"+2 to overcome when identifying the nature, origin, or weakness of a magical effect or creature.",type:"bonus"},
        {name:"Scout's Instinct",skill:"Notice",desc:"+2 to overcome when detecting an ambush or hidden enemies before they strike.",type:"bonus"},
        {name:"Silver Tongue",skill:"Rapport",desc:"+2 to create advantages by making a compelling first impression on nobles, clergy, or those who value status.",type:"bonus"},
        {name:"Fear Incarnate",skill:"Provoke",desc:"+2 to attack with Provoke against enemies who have already witnessed you defeat one of their allies this scene.",type:"bonus"},
        {name:"Battlefield Awareness",skill:"Athletics",desc:"+2 to defend against physical attacks when you have moved at least one zone this exchange.",type:"bonus"},
        {name:"Court Intrigue",skill:"Deceive",desc:"+2 to overcome when passing as a person of rank or navigating political ceremony.",type:"bonus"},
        {name:"Hunter's Eye",skill:"Shoot",desc:"+2 to attack when your target is at longer range and you have time to draw a bead.",type:"bonus"},
        {name:"Iron Constitution",skill:"Physique",desc:"+2 to overcome the effects of poison, disease, or magical affliction.",type:"bonus"},
        {name:"Hedge Magic",skill:"Crafts",desc:"+2 to create advantages representing minor enchantments, wards, or alchemical preparations.",type:"bonus"},
        {name:"Lay On Hands",skill:"Will",desc:"Once per scene, remove a mild consequence from yourself or an ally through concentrated focus or prayer.",type:"special"},
        {name:"Battle Cry",skill:"Provoke",desc:"Once per scene, your shout grants every ally in the same zone a free invoke on an aspect of your choice.",type:"special"},
        {name:"Fate's Ward",skill:"Will",desc:"Once per scene, when you or an adjacent ally would take a consequence, you may take it instead.",type:"special"},
        {name:"Dead Man's Draw",skill:"Fight",desc:"Once per scene, when taken out in combat, make one final attack before leaving the scene.",type:"special"},
        {name:"Ancient Tongue",skill:"Lore",desc:"Once per scene, read an inscription, rune, or magical seal that no living scholar should be able to decipher.",type:"special"},
        {name:"Shadow Walk",skill:"Stealth",desc:"Once per scene, move through a zone undetected even with witnesses present — they simply don't notice you.",type:"special"},
      {name:"Arcane Shield",skill:"Lore",desc:"Use Lore to defend against magical attacks.",type:"special"}, {name:"Deadly Aim",skill:"Shoot",desc:"+2 to Shoot when attacking from a hidden position.",type:"bonus"}, {name:"Divine Favor",skill:"Will",desc:"Once per session automatically succeed on a Will-based defense roll.",type:"special"}, {name:"Inspiring Leader",skill:"Rapport",desc:"+2 to Create Advantage when boosting ally morale.",type:"bonus"}, {name:"Lock-Pick Expert",skill:"Burglary",desc:"+2 to Burglary when opening physical locks.",type:"bonus"}, {name:"Merchant's Tongue",skill:"Resources",desc:"+2 to Resources when bartering for goods.",type:"bonus"}, {name:"Shadow Step",skill:"Stealth",desc:"+2 to Stealth when moving through dim light or shadows.",type:"bonus"}, {name:"Shield Bash",skill:"Fight",desc:"Use Fight to push an opponent into an adjacent zone.",type:"special"}, {name:"Shield-Wall Veteran",skill:"Physique",desc:"+2 to Defend others in your zone when you are using a shield.",type:"bonus"}, {name:"Whirlwind Attack",skill:"Fight",desc:"Once per scene attack all enemies in your zone.",type:"special"},
        {name:"Wilderness Survival",skill:"Notice",desc:"+2 to Notice when tracking creatures in the wild.",type:"bonus"},
        {name:"Words of the First Age",skill:"Lore",desc:"+2 to Provoke when speaking to magical creatures or ancient entities.",type:"bonus"}],
      scene_tone: {
          t: [
            "{FtAdj} and {FtAdj2}",
            "{FtNoun}-heavy {FtQual}",
      ...
      scene_danger: {
          ...
          v: {
            ...
            FdHazard: ["ward array", "necromantic field", "wild magic surge zone", "structural collapse", "possessed artefact", "ritual circle mid-activation", "divine censure zone", "magical trap sequence", "planar boundary anomaly", "ley line confluence"],
...
t.opposition = t.opposition.concat([
  ...
  {name:"Deep Wurm", type:"major", aspects:["It Was Here Before the Kingdom","The Tunnels Are Its Body","Swallows Horses Whole"], skills:[{name:"Fight",r:6},{name:"Physique",r:5},{name:"Stealth",r:3}], stress:6, stunt:"Tunneling: can create new zones by burrowing. Vacated zones collapse one exchange later.", qty:1},
