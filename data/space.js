    ...
    tables: {
      ...
      minor_concepts: {
          t: [
            ...
            "Alien Diplomat's Bodyguard",
            "Black-market Parts Dealer",
            "Deep-space-crazed Salvager",
            "Intergalactic Smuggler",
            "Military Surplus Drone-Operator",
            "Renegade AI in a Human Frame",
            "Salt-of-the-Earth Asteroid Miner",
            "Space-Station Security Officer",
            "Star-Chart Cartographer",
            "Void-touched Navigator",
            "Zero-G Engineering Tech",
            "Zero-G-born Illegal-jump-pilot"
          ],
          v: {
      ...
      major_concepts: {
          t: [
            ...
            "Admiral of the Rebel Fleet",
            "Bounty Hunter chasing a Ghost",
            "Captain of the Most Wanted Ship",
            "Cybernetic Mercenary looking for a soul",
            "Diplomat trying to stop a Galactic War",
            "Ex-Pirate Diplomat carrying a Black-market Black Box",
            "Last Survivor of a Dead Planet",
            "Merchant Prince of the Outer Rim",
            "Navigator who saw the Edge of the Universe",
            "Pirate King of the Asteroid Belt",
            "Researcher of Forbidden Xenotech"
          ],
          v: {
      ...
      stunts: [
        {name:"Void Instinct",skill:"Notice",desc:"+2 to overcome when scanning for threats in space or detecting vessel signatures.",type:"bonus"},
        {name:"Burn and Coast",skill:"Drive",desc:"+2 to overcome when attempting evasive manoeuvres in a spacecraft.",type:"bonus"},
        {name:"Jury Rig",skill:"Crafts",desc:"+2 to overcome when making emergency repairs to a ship system under fire or time pressure.",type:"bonus"},
        {name:"Long Shot",skill:"Shoot",desc:"+2 to attack when firing at targets in an adjacent zone at range.",type:"bonus"},
        {name:"Alien Diplomat",skill:"Rapport",desc:"+2 to create advantages when opening first contact with a species you've never encountered before.",type:"bonus"},
        {name:"Spacer Tough",skill:"Physique",desc:"+2 to defend against vacuum exposure, radiation, and other deep-space environmental hazards.",type:"bonus"},
        {name:"Read the Docking Manifest",skill:"Investigate",desc:"+2 to overcome when researching a ship, crew, or cargo by pulling public registry records.",type:"bonus"},
      ...
      scene_danger: {
          ...
          v: {
            ...
            SdHazard: ["hull breach point", "automated defence turret", "explosive decompression zone", "radiation leak", "drone intercept system", "airlock override", "engine plasma conduit", "emergency bulkhead sequence", "lethal containment protocol", "weapons locker breach"],
