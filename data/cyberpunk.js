...
CAMPAIGNS["cyberpunk"] = {
    ...
    tables: {
      ...
      minor_weaknesses: ["Kill Switch Embedded in Their Augments","Deep in Debt to the Wrong People","Will Break if You Mention Their Family","Corporate Handler Is Watching Right Now","Addicted to a Corp Pharmaceutical","Terrified of Jacking In After a Bad ICE Hit","Loyalty Covers Exactly One Person","Glitching Augment — Unpredictable Moments","Desperately Wants Out of This Life","Bought Loyalty: Name the Right Price","Corp Tracking Tag Embedded — Can't Find It, Can't Remove It","The Debt Is Larger Than They've Said and Someone Knows","Their Handler Is Watching This Conversation Right Now","Addicted to Stims — the Crash Is Sudden and Total","Kill Phrase Known to Their Former Employer","Will Not Endanger the Kid They're Supporting","Old Warrant: One Biometric Scan Away From Arrest","Tremors From a Bad ICE Hit — Hands Unreliable Under Pressure","Pride Won't Let Them Admit They Don't Know","Their Loyalty Has a Number — Someone Already Paid It","Terrified of Full Disconnection After What They Saw in the Net","Compulsion to Leave a Signature — Can't Help It","The Corp Has Leverage: Someone Who Matters","Can't Let a Civilian Get Hurt — It Slows Everything Down","Paranoid After the Last Burn: Seeing Surveillance Everywhere","Old Injury Poorly Patched by a Bad Street Doc","Deep Cover So Long They're Not Sure What's Real","Their Face Is in Three Corp Databases","Owes the Fixer More Than One Run's Pay","The Neural Jack Has Been Glitching Since the Last Dive","Socket-Sick — Jacking In Triggers Flashbacks They Cannot Control","Chrome Dependency — Goes Without an Upgrade Too Long and the Shakes Start","The Old Sleeve\'s Muscle Memory Activates at the Worst Moments","Cannot Stop Leaving a Digital Signature — It\'s Habit, Not Carelessness","Will Not Work a Job That Ends With a Civilian in a Body Bag, Even If It Costs Them","The Face They\'re Wearing Has a Past — Someone in This Room Recognises It","Their Augments Are Three Generations Old and Nobody Makes the Parts Anymore","The Corp Loyalty Protocol Was Removed Badly — Bleeds Through Under Stress","Memory Gaps From a Dirty Dive — They Don\'t Know What They Can\'t Remember","Their Real Face Is on a Most-Wanted List They Cannot Access to Read","Will Not Abandon a Downed Teammate — Has Never Once Left Anyone Behind","The Ghost in Their Head Has Its Own Priorities and Sometimes Votes","Psychosis Threshold Dangerously Close — Chrome to Meat Ratio Is a Live Hazard","Personal Code Won\'t Let Them Take a Contract Against Certain Target Types","Professional Pride Makes Them Identifiable — The Style Is the Signature","The Debt Is in Favours, Not Credits — Worse, Because Favours Have Interest","Their Augment Array Interfaces With Corp Infrastructure Passively and Automatically","Wired for Speed But Not for Subtlety — Loud and Fast Is Their Only Mode","They\'re Being Followed by Someone Patient and They Don\'t Know Why Yet","The Human Parts Are Starting to Reject the Machine Parts — They Know What That Means"],
      major_concepts: {
          t: [
      ...
      troubles: ["My Augments Are Corp Property and They Know It","There's a Kill Switch I Can't Find","I Owe Everyone and Trust No One","The Corp Has My Family","I Know What I Did to Get This Far","One More Run Was Three Runs Ago","My Loyalty Is For Sale — and Somebody Already Bought It","The Blackout Events Are Getting Longer","I Can't Tell Where the Augments End and I Begin","They're Going to Find Out What I Know","The Network Knows My Face and I Can't Change Either Fast Enough","The Addiction Is All That Gets Me Through a Shift — That's a Problem","My Notoriety Gets People Killed, Including People I Didn't Want Dead","The Corps Have My Family and They Know That I Know It","The Corp That Owns My Augments Has Activated the Warranty Clause","I Have Been Three Different People and Remember All of Them","The Last Run I Did Is Still Running — Consequences Incoming","Every Ally I Make Becomes a Target","My Reputation for Being Reliable Is Now a Trap","The Addiction Has Its Own Agenda and Votes Every Hour","I Know Who Ordered the Hit — They Don't Know I Know Yet","There Are Files That Prove Everything — They're the Only Copies","The Network Segment I Control Is All I Have Left","My Former Handler Was Good People — That's the Problem","I Have Been Dead for Two Years Legally and It's Getting Complicated","Running Hot: Every Corp Scanner in the City Has My Signature","The Thing I Did Last Year Is About to Surface","My Loyalty to the Crew Conflicts With What I Was Paid to Do","Three Different Agencies Believe I Am Working For Them","I Cannot Stop Even Though I Know What It's Doing to Me","My Sleeve Isn\'t Mine and the Previous Tenant Left Something Behind","I Have Been Three Different Bodies and the Oldest One Is Still Out There Somewhere","The Memory of What I Did Isn\'t Mine — But the Consequences Are","I Am Running on a Cortical Stack That Someone Else Has a Copy Of","The Chrome Is Past the Point Where I Can Feel Anything on That Side","I Know Too Much About One Corp to Work for Any of the Others","Every Recorded Memory I Have Was Verified by Someone Who Is Now Dead","The AI I Work With Has Started Having Opinions I Cannot Override","My Skills Were Installed — the Person Who Sold Them to Me Has a Master Copy","I Have Been Watching Myself on a Corp Security Feed for Three Weeks","My Real Identity Has Been Declared Dead and Someone Is Living It","The Wetware Is Talking to Networks I Did Not Authorise","I Have Done Things While Sleeved I Cannot Verify and Cannot Afford to Know","The Data Cache in My Head Has a Kill-Timer I Cannot Disable","I Burned Four People to Get Off-Grid and Two of Them Didn\'t Deserve It","My Loyalty Chip Was Supposed to Be Removed — Supposed To","I Am Technically the Property of a Corp That Technically No Longer Exists","The Journalist Has My Name and I Don\'t Know Who Gave It to Them","My Augment Tolerance Is Gone — Every Upgrade From Here Is a Roll of the Dice","The Thing I Uploaded Into the Net Six Months Ago Has Been Learning Without Me"],
      other_aspects: {
          t: [
      ...
      stunts: [
        {name:"Ghost Protocol",skill:"Stealth",desc:"+2 to overcome when moving undetected through surveilled corporate spaces.",type:"bonus"},
        {name:"ICE Breaker",skill:"Crafts",desc:"+2 to overcome when bypassing electronic security systems or firewalls.",type:"bonus"},
        {name:"Street Sense",skill:"Notice",desc:"+2 to defend against Deceive when in your home district or a familiar environment.",type:"bonus"},
        {name:"Combat Reflexes",skill:"Fight",desc:"+2 to defend against the first physical attack in any conflict.",type:"bonus"},
        {name:"Cold Read",skill:"Empathy",desc:"+2 to create advantages by reading someone's emotional state during negotiation.",type:"bonus"},
        {name:"Data Siphon",skill:"Investigate",desc:"+2 to overcome when extracting data from a compromised system or device.",type:"bonus"},
        {name:"Corp Speak",skill:"Deceive",desc:"+2 to create advantages by impersonating corporate authority in front of low-level security.",type:"bonus"},
        {name:"Target Designation",skill:"Shoot",desc:"+2 to attack when a teammate has already created a targeting advantage this exchange.",type:"bonus"},
        {name:"Hardline",skill:"Will",desc:"+2 to defend against mental stress from hacking, interrogation, or neural attack.",type:"bonus"},
        {name:"Street Dealer",skill:"Contacts",desc:"+2 to overcome when acquiring illegal equipment, pharmaceuticals, or black-market services.",type:"bonus"},
        {name:"Emergency Jack-Out",skill:"Crafts",desc:"Once per scene, instantly disconnect from a hostile network with no roll — but you lose everything you'd gathered that scene.",type:"special"},
        {name:"Overclocked",skill:"Athletics",desc:"Once per scene, treat a failed Athletics roll as a tie instead.",type:"special"},
        {name:"Killswitch Bluff",skill:"Provoke",desc:"Once per scene, claim to hold a kill switch on a target's augments; they must choose to flee, comply, or call your bluff.",type:"special"},
        {name:"Fixer's Favour",skill:"Contacts",desc:"Once per scene, call in a favour — a named contact appears, provides a useful item, or creates a situation aspect with a free invoke.",type:"special"},
        {name:"Neural Spike",skill:"Lore",desc:"Once per scene, when jacked into a system, force an NPC connected to that network to answer one yes/no question truthfully.",type:"special"},
        {name:"Ghost Routine",skill:"Stealth",desc:"Once per scene, make it impossible to prove you were in a location — all evidence is erased, no roll required.",type:"special"},
      {name:"Chrome Muscle",skill:"Physique",desc:"+2 to Physique when lifting or breaking heavy objects.",type:"bonus"}, {name:"Threat Assessment",skill:"Notice",desc:"+2 to Notice when determining turn order in a conflict.",type:"bonus"}, {name:"Flash-Bang",skill:"Resources",desc:"Once per scene, blind all enemies in your zone — they take a -2 to all Notice and Shoot rolls until their next action.",type:"special"}, {name:"Ice-Breaker",skill:"Crafts",desc:"+2 to Crafts when hacking corporate servers.",type:"bonus"}, {name:"Neural Overclock",skill:"Will",desc:"Once per scene take an extra action at the cost of 1 mental stress.",type:"special"}, {name:"Shadow-Run",skill:"Stealth",desc:"Use Stealth instead of Athletics to move across rooftops.",type:"special"}, {name:"Social Chameleon",skill:"Deceive",desc:"+2 to Deceive when impersonating corporate employees.",type:"bonus"}, {name:"Street Cred",skill:"Contacts",desc:"+2 to Contacts when dealing with criminal underworld figures.",type:"bonus"}, {name:"Subliminal Hack",skill:"Rapport",desc:"Use Crafts instead of Rapport to manipulate an NPC if they have active neural augments.",type:"special"}, {name:"System Crash",skill:"Investigate",desc:"Use Investigate to attack digital security systems.",type:"special"},
        {name:"Targeting Uplink",skill:"Shoot",desc:"+2 to Shoot when using smart-linked weapons.",type:"bonus"},
        {name:"Zero-Day Exploit",skill:"Crafts",desc:"Once per scene ignore a piece of ICE or a digital lock entirely without rolling.",type:"special"}],
      scene_tone: {
          t: [
            "{CtAdj} and {CtAdj2}",
      ...
      scene_danger: {
          ...
          v: {
            ...
            CdHazard: ["ICE countermeasure array", "security drone swarm", "neural feedback trap", "automated lockdown system", "armed response team", "EMP device", "toxic chemical leak", "explosive decompression point", "lethal security protocol", "data wipe trigger"],
      ...
      compel_situations: [
        ...
        "The corp's representative is making an offer that is genuinely better than the client's",
      ...
      faction_face_roles: [
        ...
        "the surgeon who keeps the membership operational",
        ...
        "the idealist whose principles are starting to cost the faction",
...
t.current_issues = t.current_issues.concat([
  "The Bandwidth Wars — Corporations throttle the net by neighborhood. Information is oxygen and someone is choking the supply.",
  "The Augment Recall — A manufacturer's implants are failing. Thousands walk around with ticking bombs in their skulls.",
]);

t.impending_issues = t.impending_issues.concat([
  "Sovereign AI — An artificial intelligence has filed for legal personhood. If it wins, every networked system becomes a potential citizen.",
  "The Substrate Collapse — The city's physical infrastructure fails faster than it can be patched. Districts are one storm from sinkholes.",
]);
