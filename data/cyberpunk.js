...
CAMPAIGNS["cyberpunk"] = {
    ...
    tables: {
      ...
      stunts: [
        ...
        {name:"Ghost Routine",skill:"Stealth",desc:"Once per scene, make it impossible to prove you were in a location - all evidence is erased, no roll required.",type:"special",tags:["stealth", "technical", "movement"]},
      {name:"Chrome Muscle",skill:"Physique",desc:"+2 to Physique when lifting or breaking heavy objects.",type:"bonus",tags:["combat", "survival", "intimidation"]}, {name:"Threat Assessment",skill:"Notice",desc:"+2 to Notice when determining turn order in a conflict.",type:"bonus",tags:["investigation", "knowledge", "combat"]}, {name:"Flash-Bang",skill:"Resources",desc:"Once per scene, blind all enemies in your zone - they take a -2 to all Notice and Shoot rolls until their next action.",type:"special",tags:["combat", "technical"]}, {name:"Ice-Breaker",skill:"Crafts",desc:"+2 to Crafts when hacking corporate servers.",type:"bonus",tags:["technical", "subterfuge", "investigation"]}, {name:"Neural Overclock",skill:"Will",desc:"Once per scene take an extra action at the cost of 1 mental stress.",type:"special",tags:["technical", "combat", "survival"]}, {name:"Shadow-Run",skill:"Stealth",desc:"Use Stealth instead of Athletics to move across rooftops.",type:"special",tags:["stealth", "movement", "subterfuge"]}, {name:"Social Chameleon",skill:"Deceive",desc:"+2 to Deceive when impersonating corporate employees.",type:"bonus",tags:["social", "subterfuge", "stealth"]}, {name:"Street Cred",skill:"Contacts",desc:"+2 to Contacts when dealing with criminal underworld figures.",type:"bonus",tags:["social", "negotiation", "leadership"]}, {name:"Subliminal Hack",skill:"Rapport",desc:"Use Crafts instead of Rapport to manipulate an NPC if they have active neural augments.",type:"special",tags:["social", "technical", "subterfuge"]}, {name:"System Crash",skill:"Investigate",desc:"Use Investigate to attack digital security systems.",type:"special",tags:["technical", "combat", "investigation"]},
        {name:"Targeting Uplink",skill:"Shoot",desc:"+2 to Shoot when using smart-linked weapons.",type:"bonus",tags:["combat", "technical"]},
