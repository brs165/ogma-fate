...
<!-- BL-16: update tool name when rebrand ships -->

This document covers the licensing of the **Fate Condensed Campaign Generator Suite** and the required attributions under the Creative Commons Attribution 3.0 Unported license.
...
You are free to share, adapt, and build upon this work, including for commercial purposes, provided you give appropriate credit. You do not need to license derivative works under the same terms.

---

## Required Attributions

The game mechanics, rules text, terminology, and structural content in this generator are derived from the following works, all licensed under CC BY 3.0. Attribution blocks are taken verbatim from the official SRD source files at https://www.faterpg.com/ and https://bookofhanz.com/licensing.

Each block must appear in your copyright section at the same text size as your other copyright text.
...
This project is not affiliated with, endorsed by, or sponsored by Evil Hat Productions, LLC. Use of Fate game mechanics under the Creative Commons license does not imply any endorsement or sponsorship by Evil Hat Productions.
...
This project does not use the Powered by Fate logo. If you create a derivative work and wish to use it, you must include:

> Fate™ is a trademark of Evil Hat Productions, LLC. The Powered by Fate logo is © Evil Hat Productions, LLC and is used with permission.

Download the logo and full requirements at: https://fate-srd.com/official-licensing-fate

---

For questions about Fate SRD licensing, contact Evil Hat Productions at feedback@evilhat.com.
